...
## Pipeline
Push to dev branch -> pull request to main branch -> GitHub Actions (Playwright UI, Docker Compose, CodeQL, etc.) -> pulled to main on success
...
- Ensure your tests are in the e2e directory. It is here that the Playwright Tests action pulls the UI tests from
